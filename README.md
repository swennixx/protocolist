...
RTF в таблице завышен для всех моделей: каждая фраза Golos длится 2–5 с, а Whisper обрабатывает окно в 30 с. На сплошной записи встречи turbo работает с RTF 0,12 (118 с записи за 14 с, вместе с загрузкой модели).
...
|---|---|---|
| Планёрка, 4 спикера (118 с) | DER 2,7 %, 4 из 4 спикеров, 2,4 с | DER 2,7 %, 4 из 4 спикеров, 13,3 с |
| Созвон с клиентом, 3 спикера (81 с) | DER 1,5 %, 3 из 3 спикеров, 1,2 с | DER 3,8 %, 3 из 3 спикеров, 6,0 с |
...
- Встроенная диаризация не разделяет одновременную речь двух людей; pyannote это умеет. Сравнить их на реальных встречах с разметкой — следующий шаг.
